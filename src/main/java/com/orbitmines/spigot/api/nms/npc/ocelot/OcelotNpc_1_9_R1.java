...
import com.orbitmines.spigot.api.nms.npc.ocelot.custom.EntityOcelot_1_9_R1;
...
public class OcelotNpc_1_9_R1 implements OcelotNpc {
    ...
    public OcelotNpc_1_9_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityOcelot_1_9_R1.class, "CustomOcelot", Id);
    }
