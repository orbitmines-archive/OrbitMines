...
import com.orbitmines.spigot.api.nms.npc.wolf.custom.EntityWolf_1_8_R1;
...
public class WolfNpc_1_8_R1 implements WolfNpc {
    ...
    public WolfNpc_1_8_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityWolf_1_8_R1.class, "CustomWolf", Id);
    }
