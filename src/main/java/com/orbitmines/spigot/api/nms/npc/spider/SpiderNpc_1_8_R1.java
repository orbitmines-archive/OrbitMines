...
import com.orbitmines.spigot.api.nms.npc.spider.custom.EntitySpider_1_8_R1;
...
public class SpiderNpc_1_8_R1 implements SpiderNpc {
    ...
    public SpiderNpc_1_8_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntitySpider_1_8_R1.class, "CustomSpider", Id);
    }
