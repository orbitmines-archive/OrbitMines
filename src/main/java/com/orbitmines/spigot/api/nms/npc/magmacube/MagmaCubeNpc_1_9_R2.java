...
import com.orbitmines.spigot.api.nms.npc.magmacube.custom.EntityMagmaCube_1_9_R2;
...
public class MagmaCubeNpc_1_9_R2 implements MagmaCubeNpc {
    ...
    public MagmaCubeNpc_1_9_R2() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityMagmaCube_1_9_R2.class, "CustomMagmaCube", Id);
    }
