...
import com.orbitmines.spigot.api.nms.npc.zombie.custom.EntityZombie_1_8_R2;
...
public class ZombieNpc_1_8_R2 implements ZombieNpc {
    ...
    public ZombieNpc_1_8_R2() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityZombie_1_8_R2.class, "CustomZombie", Id);
    }
