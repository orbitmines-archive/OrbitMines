...
import com.orbitmines.spigot.api.nms.npc.ocelot.custom.EntityOcelot_1_8_R2;
...
public class OcelotNpc_1_8_R2 implements OcelotNpc {
    ...
    public OcelotNpc_1_8_R2() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityOcelot_1_8_R2.class, "CustomOcelot", Id);
    }
