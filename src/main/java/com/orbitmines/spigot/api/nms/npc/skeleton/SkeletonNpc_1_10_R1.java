...
import com.orbitmines.spigot.api.nms.npc.skeleton.custom.EntitySkeleton_1_10_R1;
...
public class SkeletonNpc_1_10_R1 implements SkeletonNpc {
    ...
    public SkeletonNpc_1_10_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntitySkeleton_1_10_R1.class, "CustomSkeleton", Id);
    }
