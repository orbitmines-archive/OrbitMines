...
import com.orbitmines.spigot.api.nms.npc.silverfish.custom.EntitySilverfish_1_10_R1;
...
public class SilverfishNpc_1_10_R1 implements SilverfishNpc {
    ...
    public SilverfishNpc_1_10_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntitySilverfish_1_10_R1.class, "CustomSilverfish", Id);
    }
