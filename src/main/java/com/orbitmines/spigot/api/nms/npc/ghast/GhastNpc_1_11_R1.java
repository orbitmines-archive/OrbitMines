...
import com.orbitmines.spigot.api.nms.npc.ghast.custom.EntityGhast_1_11_R1;
...
public class GhastNpc_1_11_R1 implements GhastNpc {
    ...
    public GhastNpc_1_11_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityGhast_1_11_R1.class, "CustomGhast", Id);
    }
