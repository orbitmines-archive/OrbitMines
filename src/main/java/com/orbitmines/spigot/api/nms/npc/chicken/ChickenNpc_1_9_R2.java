...
import com.orbitmines.spigot.api.nms.npc.chicken.custom.EntityChicken_1_9_R2;
...
public class ChickenNpc_1_9_R2 implements ChickenNpc {
    ...
    public ChickenNpc_1_9_R2() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityChicken_1_9_R2.class, "CustomChicken", Id);
    }
