...
import com.orbitmines.spigot.api.nms.npc.chicken.custom.EntityChicken_1_9_R1;
...
public class ChickenNpc_1_9_R1 implements ChickenNpc {
    ...
    public ChickenNpc_1_9_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityChicken_1_9_R1.class, "CustomChicken", Id);
    }
