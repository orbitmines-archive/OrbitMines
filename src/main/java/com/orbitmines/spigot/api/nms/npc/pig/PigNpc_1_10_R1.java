...
import com.orbitmines.spigot.api.nms.npc.pig.custom.EntityPig_1_10_R1;
...
public class PigNpc_1_10_R1 implements PigNpc {
    ...
    public PigNpc_1_10_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityPig_1_10_R1.class, "CustomPig", Id);
    }
