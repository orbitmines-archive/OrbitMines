...
import com.orbitmines.spigot.api.nms.npc.witch.custom.EntityWitch_1_8_R2;
...
public class WitchNpc_1_8_R2 implements WitchNpc {
    ...
    public WitchNpc_1_8_R2() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityWitch_1_8_R2.class, "CustomWitch", Id);
    }
