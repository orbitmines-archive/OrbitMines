...
import com.orbitmines.spigot.api.nms.npc.ghast.custom.EntityGhast_1_9_R2;
...
public class GhastNpc_1_9_R2 implements GhastNpc {
    ...
    public GhastNpc_1_9_R2() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityGhast_1_9_R2.class, "CustomGhast", Id);
    }
