...
import com.orbitmines.spigot.api.nms.npc.silverfish.custom.EntitySilverfish_1_8_R3;
...
public class SilverfishNpc_1_8_R3 implements SilverfishNpc {
    ...
    public SilverfishNpc_1_8_R3() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntitySilverfish_1_8_R3.class, "CustomSilverfish", Id);
    }
