...
import com.orbitmines.spigot.api.nms.npc.horse.custom.EntityHorse_1_8_R1;
...
public class HorseNpc_1_8_R1 implements HorseNpc {
    ...
    public HorseNpc_1_8_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityHorse_1_8_R1.class, "CustomHorse", Id);
    }
