...
import com.orbitmines.spigot.api.nms.npc.wither.custom.EntityWither_1_8_R2;
...
public class WitherNpc_1_8_R2 implements WitherNpc {
    ...
    public WitherNpc_1_8_R2() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityWither_1_8_R2.class, "CustomWither", Id);
    }
