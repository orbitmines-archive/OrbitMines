...
import com.orbitmines.spigot.api.nms.npc.pigzombie.custom.EntityPigZombie_1_9_R1;
...
public class PigZombieNpc_1_9_R1 implements PigZombieNpc {
    ...
    public PigZombieNpc_1_9_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityPigZombie_1_9_R1.class, "CustomPigZombie", Id);
    }
