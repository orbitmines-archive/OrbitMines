 ...
 */
public class ChickenNpc_v1_9_R1 implements ChickenNpc {

    private final NpcNms npcNms;

    public ChickenNpc_v1_9_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    ...
    private class CustomChickenNpc extends EntityChicken {
        ...
        protected SoundEffect bR() {
            return options.contains(Option.DISABLE_SOUNDS) ? null : super.bR();
        }
