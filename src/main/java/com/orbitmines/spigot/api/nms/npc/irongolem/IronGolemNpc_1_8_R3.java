...
import com.orbitmines.spigot.api.nms.npc.irongolem.custom.EntityIronGolem_1_8_R3;
...
public class IronGolemNpc_1_8_R3 implements IronGolemNpc {
    ...
    public IronGolemNpc_1_8_R3() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityIronGolem_1_8_R3.class, "CustomIronGolem", Id);
    }
