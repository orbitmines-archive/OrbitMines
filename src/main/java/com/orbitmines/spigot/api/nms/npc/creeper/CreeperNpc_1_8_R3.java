...
import com.orbitmines.spigot.api.nms.npc.creeper.custom.EntityCreeper_1_8_R3;
...
public class CreeperNpc_1_8_R3 implements CreeperNpc {
    ...
    public CreeperNpc_1_8_R3() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityCreeper_1_8_R3.class, "CustomCreeper", Id);
    }
