...
import com.orbitmines.spigot.api.nms.npc.enderman.custom.EntityEnderman_1_12_R1;
...
public class EndermanNpc_1_12_R1 implements EndermanNpc {
    ...
    public EndermanNpc_1_12_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityEnderman_1_12_R1.class, "CustomEnderman", Id);
    }
