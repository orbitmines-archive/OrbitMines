...
import com.orbitmines.spigot.api.nms.npc.witch.custom.EntityWitch_1_8_R1;
...
public class WitchNpc_1_8_R1 implements WitchNpc {
    ...
    public WitchNpc_1_8_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityWitch_1_8_R1.class, "CustomWitch", Id);
    }
