...
import com.orbitmines.spigot.api.nms.npc.irongolem.custom.EntityIronGolem_1_8_R2;
...
public class IronGolemNpc_1_8_R2 implements IronGolemNpc {
    ...
    public IronGolemNpc_1_8_R2() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityIronGolem_1_8_R2.class, "CustomIronGolem", Id);
    }
