...
import com.orbitmines.spigot.api.nms.npc.llama.custom.EntityLlama_1_12_R1;
...
public class LlamaNpc_1_12_R1 implements LlamaNpc {
    ...
    public LlamaNpc_1_12_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityLlama_1_12_R1.class, "CustomLlama", Id);
    }
