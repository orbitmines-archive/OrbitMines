...
import com.orbitmines.spigot.api.nms.npc.witch.custom.EntityWitch_1_8_R3;
...
public class WitchNpc_1_8_R3 implements WitchNpc {
    ...
    public WitchNpc_1_8_R3() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityWitch_1_8_R3.class, "CustomWitch", Id);
    }
