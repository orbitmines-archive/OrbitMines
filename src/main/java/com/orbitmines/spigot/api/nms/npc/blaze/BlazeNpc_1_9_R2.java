...
import com.orbitmines.spigot.api.nms.npc.blaze.custom.EntityBlaze_1_9_R2;
...
public class BlazeNpc_1_9_R2 implements BlazeNpc {
    ...
    public BlazeNpc_1_9_R2() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityBlaze_1_9_R2.class, "CustomBlaze", Id);
    }
