...
import com.orbitmines.spigot.api.nms.npc.squid.custom.EntitySquid_1_9_R1;
...
public class SquidNpc_1_9_R1 implements SquidNpc {
    ...
    public SquidNpc_1_9_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntitySquid_1_9_R1.class, "CustomSquid", Id);
    }
