...
import com.orbitmines.spigot.api.nms.npc.squid.custom.EntitySquid_1_8_R2;
...
public class SquidNpc_1_8_R2 implements SquidNpc {
    ...
    public SquidNpc_1_8_R2() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntitySquid_1_8_R2.class, "CustomSquid", Id);
    }
