...
import com.orbitmines.spigot.api.nms.npc.vindicator.custom.EntityVindicator_1_11_R1;
...
public class VindicatorNpc_1_11_R1 implements VindicatorNpc {
    ...
    public VindicatorNpc_1_11_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityVindicator_1_11_R1.class, "CustomVindicator", Id);
    }
