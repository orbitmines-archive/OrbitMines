...
import com.orbitmines.spigot.api.nms.npc.villager.custom.EntityVillager_1_9_R1;
...
public class VillagerNpc_1_9_R1 implements VillagerNpc {
    ...
    public VillagerNpc_1_9_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityVillager_1_9_R1.class, "CustomVillager", Id);
    }
