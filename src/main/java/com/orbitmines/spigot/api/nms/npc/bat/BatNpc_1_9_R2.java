...
import com.orbitmines.spigot.api.nms.npc.bat.custom.EntityBat_1_9_R2;
...
public class BatNpc_1_9_R2 implements BatNpc {
    ...
    public BatNpc_1_9_R2() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityBat_1_9_R2.class, "CustomBat", Id);
    }
