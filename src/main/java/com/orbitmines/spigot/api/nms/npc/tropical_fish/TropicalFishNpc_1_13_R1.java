package com.orbitmines.spigot.api.nms.npc.tropical_fish;
...
public class TropicalFishNpc_1_13_R1 implements TropicalFishNpc {

    private final NpcNms npcNms;

    public TropicalFishNpc_1_13_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    private static class CustomTropicalFishNpc extends EntityTropicalFish {
        ...
        protected SoundEffect dD() {
            return options.contains(Option.DISABLE_SOUNDS) ? null : super.dD();
        }
