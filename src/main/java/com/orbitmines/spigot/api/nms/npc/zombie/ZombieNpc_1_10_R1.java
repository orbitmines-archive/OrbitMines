...
import com.orbitmines.spigot.api.nms.npc.zombie.custom.EntityZombie_1_10_R1;
...
public class ZombieNpc_1_10_R1 implements ZombieNpc {
    ...
    public ZombieNpc_1_10_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityZombie_1_10_R1.class, "CustomZombie", Id);
    }
