 ...
 */
public class ChickenNpc_v1_10_R1 implements ChickenNpc {

    private final NpcNms npcNms;

    public ChickenNpc_v1_10_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    ...
    private class CustomChickenNpc extends EntityChicken {
        ...
        protected SoundEffect bV() {
            return options.contains(Option.DISABLE_SOUNDS) ? null : super.bV();
        }
