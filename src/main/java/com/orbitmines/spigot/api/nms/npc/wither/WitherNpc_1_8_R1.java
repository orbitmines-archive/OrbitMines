...
import com.orbitmines.spigot.api.nms.npc.wither.custom.EntityWither_1_8_R1;
...
public class WitherNpc_1_8_R1 implements WitherNpc {
    ...
    public WitherNpc_1_8_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityWither_1_8_R1.class, "CustomWither", Id);
    }
