...
public class EntityNms_1_13_R2 implements EntityNms {
    ...
    public int nextEntityId() {
        try {
            Field entityCount = ReflectionUtils.getDeclaredField(net.minecraft.server.v1_13_R2.Entity.class, "entityCount");
