...
import com.orbitmines.spigot.api.nms.npc.magmacube.custom.EntityMagmaCube_1_11_R1;
...
public class MagmaCubeNpc_1_11_R1 implements MagmaCubeNpc {
    ...
    public MagmaCubeNpc_1_11_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityMagmaCube_1_11_R1.class, "CustomMagmaCube", Id);
    }
