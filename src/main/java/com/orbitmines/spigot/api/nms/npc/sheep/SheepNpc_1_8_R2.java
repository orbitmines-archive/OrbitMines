...
import com.orbitmines.spigot.api.nms.npc.sheep.custom.EntitySheep_1_8_R2;
...
public class SheepNpc_1_8_R2 implements SheepNpc {
    ...
    public SheepNpc_1_8_R2() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntitySheep_1_8_R2.class, "CustomSheep", Id);
    }
