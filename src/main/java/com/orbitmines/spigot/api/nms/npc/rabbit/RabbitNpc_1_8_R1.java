...
import com.orbitmines.spigot.api.nms.npc.rabbit.custom.EntityRabbit_1_8_R1;
...
public class RabbitNpc_1_8_R1 implements RabbitNpc {
    ...
    public RabbitNpc_1_8_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityRabbit_1_8_R1.class, "CustomRabbit", Id);
    }
