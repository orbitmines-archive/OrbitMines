...
import com.orbitmines.spigot.api.nms.npc.bat.custom.EntityBat_1_9_R1;
...
public class BatNpc_1_9_R1 implements BatNpc {
    ...
    public BatNpc_1_9_R1() {
        OrbitMines.getInstance().getNms().npc().addCustomEntity(EntityBat_1_9_R1.class, "CustomBat", Id);
    }
