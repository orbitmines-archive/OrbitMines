...
public enum SkyBlockAchievements implements Achievement {
    ...
    SkyBlockAchievements(String name, Rarity rarity, Loot.Instance reward, String... description) {
        this(name, rarity, new Loot.Instance[] { reward }, description);
    }

    SkyBlockAchievements(String name, Rarity rarity, Loot.Instance[] rewards, String... description) {
        this.name = name;
        this.rarity = rarity;
