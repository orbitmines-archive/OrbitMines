...
import com.orbitmines.spigot.servers.uhsurvival.handlers.mob.mobs.Arrow;
import com.orbitmines.spigot.servers.uhsurvival.handlers.mob.mobtypes.Zombie;
...
public class MobManager {
    ...
    public MobManager(Map map) {
        ...
        mobTypes.put(EntityType.ARROW, new com.orbitmines.spigot.servers.uhsurvival.handlers.mob.mobtypes.Arrow());
        this.init();
    }
