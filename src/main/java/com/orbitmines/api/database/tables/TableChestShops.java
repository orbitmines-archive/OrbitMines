...
public class TableChestShops extends Table {
    ...
    public static final Column MATERIAL_ID = new Column("MaterialId", Column.Type.SMALLINT);
    public static final Column DURABILITY = new Column("Durability", Column.Type.SMALLINT);
    ...
    public TableChestShops() {
        super("ChestShops", SERVER, ID, OWNER, LOCATION, MATERIAL_ID, DURABILITY, TYPE, AMOUNT, PRICE);
    }
}
