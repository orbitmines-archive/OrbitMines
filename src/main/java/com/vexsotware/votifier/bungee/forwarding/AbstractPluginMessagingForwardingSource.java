...
public abstract class AbstractPluginMessagingForwardingSource implements ForwardingVoteSource {
    ...
    protected final MadBlockBungee nuVotifier;
    protected final String channel;
    protected final VoteCache cache;
    protected final List<String> ignoredServers;

    public AbstractPluginMessagingForwardingSource(String channel, List<String> ignoredServers, MadBlockBungee nuVotifier, VoteCache cache) {
    ...
    protected AbstractPluginMessagingForwardingSource(String channel, MadBlockBungee nuVotifier, VoteCache voteCache) {
