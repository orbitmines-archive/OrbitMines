package com.vexsotware.votifier.bungee.forwarding.proxy;
...
public class ProxyForwardingVoteSource implements ForwardingVoteSource {
    ...
    private final MadBlockBungee plugin;
    ...
    public ProxyForwardingVoteSource(MadBlockBungee plugin, NioEventLoopGroup eventLoopGroup, List<BackendServer> backendServers, VoteCache voteCache) {
        this.plugin = plugin;
