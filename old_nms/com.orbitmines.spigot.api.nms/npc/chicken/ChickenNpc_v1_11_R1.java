 ...
 */
public class ChickenNpc_v1_11_R1 implements ChickenNpc {

    private final NpcNms npcNms;

    public ChickenNpc_v1_11_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    ...
    private class CustomChickenNpc extends EntityChicken {
        ...
        protected SoundEffect bW() {
            return options.contains(Option.DISABLE_SOUNDS) ? null : super.bW();
        }

        @Override
        protected SoundEffect bX() {
            return options.contains(Option.DISABLE_SOUNDS) ? null : super.bX();
        }
    }
