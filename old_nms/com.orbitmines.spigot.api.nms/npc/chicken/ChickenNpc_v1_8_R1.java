 ...
 */
public class ChickenNpc_v1_8_R1 implements ChickenNpc {

    private final NpcNms npcNms;//TODO ALL CHICKEN RIDEABLES FLY/HOVER WHEN IN AIR?

    public ChickenNpc_v1_8_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    ...
    private class CustomChickenNpc extends EntityChicken {
        ...
        @Override
        protected String bn() {
            return options.contains(Option.DISABLE_SOUNDS) ? null : super.bn();
        }
