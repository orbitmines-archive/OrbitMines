...
public class NpcNms_1_8_R2 implements NpcNms {
    ...
    public float[] handleMovement(Entity rideable, float speed, float backMultiplier, float sideMultiplier, float walkHeight) {
        ...
        try {
            ReflectionUtils.getDeclaredMethod(net.minecraft.server.v1_8_R2.Entity.class, "setYawPitch", float.class, float.class).invoke(nmsRideable.yaw, nmsRideable.pitch);
