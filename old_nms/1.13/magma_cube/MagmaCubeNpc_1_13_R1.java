package com.orbitmines.spigot.api.nms.npc.magma_cube;
...
public class MagmaCubeNpc_1_13_R1 implements MagmaCubeNpc {

    private final NpcNms npcNms;

    public MagmaCubeNpc_1_13_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    private static class CustomMagmaCubeNpc extends EntityMagmaCube {
        ...
        protected SoundEffect dx() {
            return options.contains(Option.DISABLE_SOUNDS) ? null : super.dx();
        }
